...
- [PDF BOM Extractor](./pdf-bom-extractor.mdx) — Pull BOM tables from CAD PDFs into CSV.
- [PDF Number Extractor](./pdf-number-extractor.mdx) — Highlight QA serials and inspection numbers from PDFs.
- [Blind Flange Calculator](./blind-flange-calculator.mdx) — EN 13445-3 blind flange sizing.
