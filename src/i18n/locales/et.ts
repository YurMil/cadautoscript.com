...
export const et: TranslationDict = {
  ...
  workspaces: {
    eyebrow: 'Meeskond',
    title: 'Tööruumid',
    subtitle: 'Jagage arvutuste ajalugu ja aruannete vaikeväärtusi kolleegidega. Kutsuge nad lingiga.',
    loading: 'Tööruumide laadimine…',
    error: 'Tööruume ei õnnestunud laadida.',
    empty: 'Te ei kuulu veel ühtegi tööruumi.',
    createLabel: 'Uue tööruumi nimi',
    createPlaceholder: 'nt Surveanumate meeskond',
    create: 'Loo tööruum',
    creating: 'Loomine…',
    select: 'Tööruum',
    roleOwner: 'Omanik',
    roleMember: 'Liige',
    you: 'teie',
    membersTitle: 'Liikmed ({count})',
    remove: 'Eemalda',
    removeConfirm: 'Kas eemaldada {name} sellest tööruumist?',
    inviteTitle: 'Kutsu kolleege',
    inviteHint: 'Selle lingiga saab liituda 7 päeva jooksul. Seda näidatakse ainult üks kord, seega kopeerige see kohe.',
    createInvite: 'Loo kutselink',
    copyInvite: 'Kopeeri link',
    inviteCopied: 'Kopeeritud',
    revokeInvites: 'Tühista kõik kutselingid',
    invitesRevoked: 'Kõik kutselingid on tühistatud.',
    defaultsTitle: 'Aruannete vaikeväärtused',
    defaultsHint: 'Kasutatakse kirjanurkades ja aruannetes tööriistades, mis seda toetavad.',
    name: 'Tööruumi nimi',
    companyName: 'Ettevõtte nimi',
    preferredStandards: 'Eelistatud standardid',
    preferredStandardsPlaceholder: 'nt EN 13445, DIN 28011',
    save: 'Salvesta',
    saved: 'Salvestatud',
    ownerOnly: 'Neid saab muuta ainult omanik.',
    historyTitle: 'Jagatud ajalugu',
    historySubtitle: 'Liikmete salvestatud viimased {max} kirjet.',
    historyEmpty: 'Midagi pole veel jagatud. Valige see tööruum tööriistas valiku „Salvesta asukohta“ alt.',
    savedBy: 'autor {name}',
    leave: 'Lahku tööruumist',
    leaveConfirm: 'Kas lahkuda tööruumist {name}? Kaotate juurdepääsu selle jagatud ajaloole.',
    deleteWorkspace: 'Kustuta tööruum',
    deleteConfirm: 'Kas kustutada {name} ja selle jagatud ajalugu kõigi liikmete jaoks? Seda ei saa tagasi võtta.',
    actionFailed: 'Midagi läks valesti. Palun proovige uuesti.',
    joinTitle: 'Liitu tööruumiga',
    joinSignIn: 'Kutse vastuvõtmiseks logige sisse.',
    joinAccept: 'Liitu tööruumiga',
    joining: 'Liitumine…',
    joinSuccess: 'Olete tööruumiga liitunud.',
    joinOpenWorkspaces: 'Ava tööruumid',
    joinInvalid: 'See kutselink on kehtetu või aegunud. Paluge omanikult uus.',
    joinMissingCode: 'See link ei sisalda kutsekoodi.',
    saveTo: 'Salvesta asukohta',
