...
export const de: TranslationDict = {
  ...
  home: {
    ...
    engineeringEyebrow: 'Ingenieurwerkzeuge',
    engineeringTitle: 'Rechner, Konfiguratoren und CAD-Werkzeuge',
    extrasEyebrow: 'Extras',
    extrasTitle: 'Allgemeine Werkzeuge und Minispiele',
    extrasLead: 'Produktivitätswerkzeuge und Browserspiele ohne Bezug zu einer Auslegungsnorm – nur einen Klick entfernt.',
    browseGeneralUtilities: 'Allgemeine Werkzeuge ansehen',
    playMiniGames: 'Minispiele spielen',
  },
  utility: {
    fullScreen: 'Vollbild',
  ...
  workspaces: {
    ...
    subtitle: 'Teilen Sie Berechnungsverlauf und Berichtsvorgaben mit Kollegen. Laden Sie sie per Link ein.',
    loading: 'Arbeitsbereiche werden geladen…',
    error: 'Arbeitsbereiche konnten nicht geladen werden.',
    empty: 'Sie sind noch in keinem Arbeitsbereich.',
    createLabel: 'Name des neuen Arbeitsbereichs',
    createPlaceholder: 'z. B. Team Druckbehälter',
    ...
    roleMember: 'Mitglied',
    you: 'Sie',
    membersTitle: 'Mitglieder ({count})',
    remove: 'Entfernen',
    removeConfirm: '{name} aus diesem Arbeitsbereich entfernen?',
    inviteTitle: 'Kollegen einladen',
    inviteHint: 'Jeder mit diesem Link kann 7 Tage lang beitreten. Er wird nur einmal angezeigt – kopieren Sie ihn jetzt.',
    createInvite: 'Einladungslink erstellen',
    copyInvite: 'Link kopieren',
    inviteCopied: 'Kopiert',
    revokeInvites: 'Alle Einladungslinks widerrufen',
    invitesRevoked: 'Alle Einladungslinks wurden widerrufen.',
    defaultsTitle: 'Berichtsvorgaben',
    defaultsHint: 'Für Schriftfelder und Berichte in Werkzeugen, die dies unterstützen.',
    name: 'Name des Arbeitsbereichs',
    companyName: 'Firmenname',
    preferredStandards: 'Bevorzugte Normen',
    preferredStandardsPlaceholder: 'z. B. EN 13445, DIN 28011',
    save: 'Speichern',
    saved: 'Gespeichert',
    ownerOnly: 'Nur der Inhaber kann dies ändern.',
    historyTitle: 'Gemeinsamer Verlauf',
    historySubtitle: 'Die neuesten {max} von Mitgliedern gespeicherten Einträge.',
    historyEmpty: 'Noch nichts geteilt. Wählen Sie diesen Arbeitsbereich in einem Werkzeug unter „Speichern in“.',
    savedBy: 'von {name}',
    leave: 'Arbeitsbereich verlassen',
    leaveConfirm: '{name} verlassen? Sie verlieren den Zugriff auf den gemeinsamen Verlauf.',
    deleteWorkspace: 'Arbeitsbereich löschen',
    deleteConfirm: '{name} und den gemeinsamen Verlauf für alle Mitglieder löschen? Dies kann nicht rückgängig gemacht werden.',
    actionFailed: 'Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.',
    joinTitle: 'Einem Arbeitsbereich beitreten',
    joinSignIn: 'Melden Sie sich an, um diese Einladung anzunehmen.',
    joinAccept: 'Arbeitsbereich beitreten',
    joining: 'Beitritt läuft…',
    joinSuccess: 'Sie sind dem Arbeitsbereich beigetreten.',
    joinOpenWorkspaces: 'Arbeitsbereiche öffnen',
    joinInvalid: 'Dieser Einladungslink ist ungültig oder abgelaufen. Bitten Sie den Inhaber um einen neuen.',
    joinMissingCode: 'Dieser Link enthält keinen Einladungscode.',
    saveTo: 'Speichern in',
    personalHistory: 'Persönlicher Verlauf',
  },
  newsletter: {
    ...
    confirmHint:
      'Sofern diese Adresse noch nicht angemeldet ist, ist ein Bestätigungslink unterwegs. Das Abonnement beginnt erst, wenn Sie ihn anklicken.',
    ...
    consent:
      'Mit dem Abonnement stimmen Sie zu, Produkt-Updates an diese Adresse zu erhalten. Sie wird ausschließlich dafür gespeichert, niemals weitergegeben oder verkauft, und jede E-Mail enthält einen Ein-Klick-Abmeldelink.',
    confirming: 'Abonnement wird bestätigt...',
    confirmSuccess: 'Abonnement bestätigt. Vielen Dank — wir melden uns, sobald es Neues gibt.',
    alreadyConfirmed: 'Dieses Abonnement wurde bereits bestätigt. Es ist nichts weiter zu tun.',
    confirmInvalid: 'Dieser Bestätigungslink ist ungültig. Möglicherweise wurde er bereits verwendet — fordern Sie auf der Website einen neuen an.',
    confirmFailed: 'Das Abonnement konnte gerade nicht bestätigt werden. Bitte versuchen Sie den Link in Kürze erneut.',
    unsubscribeTitle: 'Abmelden',
    unsubscribing: 'Ihre Adresse wird entfernt...',
    unsubscribeSuccess: 'Sie wurden abgemeldet. An diese Adresse werden keine weiteren E-Mails gesendet.',
    alreadyUnsubscribed: 'Diese Adresse war bereits abgemeldet.',
    unsubscribeInvalid: 'Dieser Abmeldelink ist ungültig.',
    unsubscribeFailed: 'Das konnte gerade nicht verarbeitet werden. Bitte versuchen Sie den Link in Kürze erneut.',
  ...
  generalUtilitiesPage: {
    ...
    lead: 'Datei-, Planungs- und Datenwerkzeuge, die die Ingenieurarbeit unterstützen, ohne an eine Auslegungsnorm gebunden zu sein. Alles läuft lokal in Ihrem Browser.',
    sectionEyebrow: 'Allgemeine Werkzeuge',
    sectionTitle: 'Produktivitätswerkzeuge',
    backToEngineering: 'Zurück zu den Ingenieurwerkzeugen',
  },
  miniGamesPage: {
    eyebrow: 'Minispiele',
