...
export const es: TranslationDict = {
  ...
  workspaces: {
    ...
    subtitle: 'Comparta el historial de cálculos y los valores predeterminados de informes con sus colegas. Invítelos con un enlace.',
    loading: 'Cargando espacios de trabajo…',
    error: 'No se pudieron cargar los espacios de trabajo.',
    empty: 'Todavía no pertenece a ningún espacio de trabajo.',
    createLabel: 'Nombre del nuevo espacio de trabajo',
    createPlaceholder: 'p. ej. Equipo de recipientes a presión',
    create: 'Crear espacio de trabajo',
    creating: 'Creando…',
    select: 'Espacio de trabajo',
    roleOwner: 'Propietario',
    roleMember: 'Miembro',
    you: 'usted',
    membersTitle: 'Miembros ({count})',
    remove: 'Quitar',
    removeConfirm: '¿Quitar a {name} de este espacio de trabajo?',
    inviteTitle: 'Invitar a colegas',
    inviteHint: 'Cualquier persona con este enlace puede unirse durante 7 días. Solo se muestra una vez, así que cópielo ahora.',
    createInvite: 'Crear enlace de invitación',
    copyInvite: 'Copiar enlace',
    inviteCopied: 'Copiado',
    revokeInvites: 'Revocar todos los enlaces de invitación',
    invitesRevoked: 'Se han revocado todos los enlaces de invitación.',
    defaultsTitle: 'Valores predeterminados de informes',
    defaultsHint: 'Se usan en cajetines e informes de las utilidades que los admiten.',
    name: 'Nombre del espacio de trabajo',
    companyName: 'Nombre de la empresa',
    preferredStandards: 'Normas preferidas',
    preferredStandardsPlaceholder: 'p. ej. EN 13445, DIN 28011',
    save: 'Guardar',
    saved: 'Guardado',
    ownerOnly: 'Solo el propietario puede cambiar esto.',
    historyTitle: 'Historial compartido',
    historySubtitle: 'Las últimas {max} entradas guardadas por los miembros.',
    historyEmpty: 'Aún no se ha compartido nada. Elija este espacio de trabajo en «Guardar en» dentro de una utilidad.',
    savedBy: 'por {name}',
    leave: 'Salir del espacio de trabajo',
    leaveConfirm: '¿Salir de {name}? Perderá el acceso a su historial compartido.',
    deleteWorkspace: 'Eliminar espacio de trabajo',
    deleteConfirm: '¿Eliminar {name} y su historial compartido para todos los miembros? Esta acción no se puede deshacer.',
    actionFailed: 'Algo salió mal. Inténtelo de nuevo.',
    joinTitle: 'Unirse a un espacio de trabajo',
    joinSignIn: 'Inicie sesión para aceptar esta invitación.',
    joinAccept: 'Unirse al espacio de trabajo',
    joining: 'Uniéndose…',
    joinSuccess: 'Se ha unido al espacio de trabajo.',
    joinOpenWorkspaces: 'Abrir espacios de trabajo',
    joinInvalid: 'Este enlace de invitación no es válido o ha caducado. Pida uno nuevo al propietario.',
    joinMissingCode: 'Este enlace no contiene un código de invitación.',
    saveTo: 'Guardar en',
  ...
  newsletter: {
    ...
    confirmHint:
      'Si esa dirección aún no está suscrita, el enlace de confirmación va en camino. La suscripción empieza solo cuando lo pulses.',
    invalidEmail: 'Eso no parece una dirección de correo.',
    failed: 'Algo salió mal. Inténtalo de nuevo en un momento.',
    consent:
      'Al suscribirte aceptas recibir novedades del producto en esta dirección. Se guarda únicamente para eso, nunca se comparte ni se vende, y cada correo lleva un enlace de baja en un clic.',
    confirming: 'Confirmando tu suscripción...',
    confirmSuccess: 'Suscripción confirmada. Gracias — te escribiremos cuando haya novedades.',
    alreadyConfirmed: 'Esta suscripción ya estaba confirmada. No hay nada más que hacer.',
    confirmInvalid: 'Este enlace de confirmación no es válido. Puede que ya se haya usado — solicita uno nuevo en el sitio.',
    confirmFailed: 'No hemos podido confirmar la suscripción ahora mismo. Prueba el enlace en unos instantes.',
    unsubscribeTitle: 'Cancelar suscripción',
    unsubscribing: 'Eliminando tu dirección...',
    unsubscribeSuccess: 'Te has dado de baja. No se enviarán más correos a esta dirección.',
    alreadyUnsubscribed: 'Esta dirección ya estaba dada de baja.',
    unsubscribeInvalid: 'Este enlace de baja no es válido.',
    unsubscribeFailed: 'No hemos podido procesarlo ahora mismo. Prueba el enlace en unos instantes.',
    backHome: 'Volver a las utilidades',
  },
  settings: {
    title: 'Configuración',
